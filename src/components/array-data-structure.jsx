...
/**interview-prep-app - version 16.16 - ArrayDataStructure 
 * - Features: 
 * 
 *   --> Destructuring 'stringsUnshift' from the context.
 * 
...
const ArrayDataStructure = () => {
    ...
    const { strings, newStrings, newStringspop,  stringsUnshift } = useAppContext()
