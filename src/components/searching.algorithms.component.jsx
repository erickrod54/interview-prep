...
/**interview-prep-app - version 38.13-  SearchingAlgorithms - Features: 
 * 
...
const SearchingAlgorithms = () => {
    ...
    const { graphsData,
             ...
             numberssearching,
             beastindexofvalue,
             beastindexofHandler, beastfindindexvalue, beastfindindexHandler, beastincludesvalue   } = useAppContext();
