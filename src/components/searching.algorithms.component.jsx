...
/**interview-prep-app - version 38.09-  SearchingAlgorithms - Features: 
 * 
 *     --> Clearing 'setBeastfindindexvalue'
 * 
 * 
...
const SearchingAlgorithms = () => {
    ...
    const { graphsData, beasts, numberssearching, beastindexofvalue, beastindexofHandler, beastfindindexvalue, beastfindindexHandler  } = useAppContext();
    ...
    const numbers = numberssearching;
    ...
    class BinarySearchTree {
      ...
      function traversePreOrder(node, list){
        ...
        /**to create this order i push before the conditions */
        list.push(node.value)
      ...
      function traversePostOrder(node, list){
        ...
        if (node.right) {
         ...
         /**to create this order i push after the conditions */
        list.push(node.value)
        ...
        <DataStructuresWrapper>
            ...
            <h3>
                ...
                <p>
                 ...
                 <img src={DFSinorder} className="large" alt="DFS inorder"/> 
                ...
                <img src={DFSinpostorder} className="large" alt="DFS in post order"/>       
